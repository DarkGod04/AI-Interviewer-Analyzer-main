                                ...
                                <div className="mt-5">
                                    ...
                                    <div className="mt-3 grid grid-cols-2 gap-10">
                                        ...
                                        <div >
                                            ...
                                            <Progress value={feedback?.rating.communication * 10} max={10} className="mt-1" />
                                        </div>
                                        <div >
                                            <h2 className="flex justify-between"> Problem Solving <span>{feedback?.rating.problemSolving}/10</span></h2>
                                            <Progress value={feedback?.rating.problemSolving * 10} max={10} className="mt-1" />
                                        </div>
                                        <div >
                                        ...
                                        <div className="col-span-2 border rounded-lg p-3 bg-gray-50">
                                            <h2 className="flex justify-between font-semibold">
                                                Tone Analysis
                                                <span className="text-primary">{feedback?.toneAnalysis || "N/A"}</span>
                                            </h2>
                                            <div className="mt-2">
                                                <h2 className="flex justify-between text-sm text-gray-600"> Tone Rating <span>{feedback?.rating.tone}/10</span></h2>
                                                <Progress value={feedback?.rating.tone * 10} max={10} className="mt-1" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
