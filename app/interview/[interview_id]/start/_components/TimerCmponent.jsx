...
function TimerComponent({ isInterviewActive = false }) {
  ...
  const totalDurationMinutes = interviewInfo?.interviewData?.duration || 30
  ...
  return (
    <div className="flex flex-col items-end text-sm">
      <div className="flex items-center gap-2 mb-1">
        ...
        <div className={`font-mono text-base font-bold ${isOvertime ? 'text-red-500' :
      ...
      <div className="w-32 bg-gray-200 rounded-full h-2 relative">
        <div
          className={`h-2 rounded-full transition-all duration-1000 ${isOvertime ? 'bg-red-500' :
